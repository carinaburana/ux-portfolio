...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const toggleMenu = useCallback(() => {
    ...
    if (target) {
      console.log("Menu opened"); // internal side-effect ok
      onMenuOpen?.(); // optional, only fires if a CLIENT parent supplies it
      playOpen();
    } else {
  ...
  return (
    <div className="sm-scope w-full h-full">
      <div
        className={
          (className ? className + " " : "") +
          "staggered-menu-wrapper relative z-[60]"
        }
        style={
          accentColor
      ...
      >
        <div
          ref={preLayersRef}
          className="sm-prelayers fixed top-0 right-0 bottom-0 pointer-events-none z-[55]"
          aria-hidden="true"
        >
          {(() => {
            const raw =
...
.sm-scope .staggered-menu-header { position: fixed; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: transparent; pointer-events: none; z-index: 100; }
.sm-scope .staggered-menu-header > * { pointer-events: auto; }
.sm-scope .sm-logo { display: flex; align-items: center; user-select: none; }
.sm-scope .sm-logo-img { display: block; height: 32px; width: auto; object-fit: contain; }
.sm-scope .sm-toggle { position: relative; display: inline-flex; align-items: center; gap: 0.3rem; background: transparent; border: none; cursor: pointer; color: #e9e9ef; font-weight: 500; line-height: 1; overflow: visible; }
.sm-scope .staggered-menu-wrapper[data-open] .sm-toggle { color:#111; }
...
.sm-scope .staggered-menu-panel { position: fixed; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 80; }
.sm-scope [data-position='left'] .staggered-menu-panel { right: auto; left: 0; }
.sm-scope .sm-prelayers { position: fixed; top: 0; right: 0; bottom: 0; width: clamp(260px, 38vw, 420px); pointer-events: none; z-index: 70; }
